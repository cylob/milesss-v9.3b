...
#if defined(__BORLANDC__) || defined(IS_MAC) || defined(IS_PS2) || defined(IS_PS3) || defined(IS_WII) || defined(IS_PSP) || defined(IS_3DS) || defined(IS_PSP2) || defined(IS_WIIU) || defined(__RADSEKRIT2__)
   if (setjmp(errhand)) {
#else
   if (_setjmp(errhand)) {
#endif
